...
def check_mentions(api, keywords, since_id):
    ...
    for tweet in tweepy.Cursor(api.mentions_timeline, since_id=since_id).items():
        ...
        if tweet.in_reply_to_status_id is None:
            api.update_status(
                status="@" + tweet.user.screen_name + " Tweet ID: " + tweet.id + " Alternative Case Bot Error 01: This bot does not support mentioning straight from a tweet. For more information, visit: https://tlegx.rf.gd",
